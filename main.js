...
const task2 = function createPlayer(className, name, life, image) {
  ...
  $player.classList.add(className);      //'player1'
  ...
  const $life = document.createElement('div');
  $life.classList.add('life');
  $life.style.width = life + '%';     // '100%'

  const $name = document.createElement('div');
  $name.classList.add('name');
  $name.innerText = name;             // 'Scorpion'
  ...
  const $img = document.createElement('img');
  $img.src = image;   // 'http://reactmarathon-api.herokuapp.com/assets/scorpion.gif';
...
const task3 = function createPlayer(className, player) {
  ...
  const $life = document.createElement('div');
  $life.classList.add('life');
  $life.style.width = player.hp + '%';     // '100%'

  const $name = document.createElement('div');
  $name.classList.add('name');
  $name.innerText = player.name;             // 'Scorpion'
  ...
  const $img = document.createElement('img');
  $img.src = player.img;   // 'http://reactmarathon-api.herokuapp.com/assets/scorpion.gif';
